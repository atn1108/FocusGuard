...
Tải source về (chọn 1 trong 2):

- **Git**: `git clone https://github.com/atn1108/FocusGuard.git`
- **ZIP**: vào [trang GitHub](https://github.com/atn1108/FocusGuard) → **Code** → **Download ZIP** rồi giải nén.
